...
public class TeleportManager {
    ...
    public void onEnable() {
        try {
            ...
            YakRealms.log("TeleportManager enabled successfully");
        } catch (Exception e) {
    ...
    /**
     * Creates a new teleport session for a player (legacy method for backward compatibility)
     *
    ...
    public boolean startTeleport(Player player, TeleportDestination destination,
        ...
        return startTeleport(player, destination, castingTime, consumable, effectType, null);
    }

    /**
     * Creates a new teleport session for a player with custom display name
     *
     * @param player            The player to teleport
     * @param destination       The destination
     * @param castingTime       The casting time in seconds
     * @param consumable        The item to consume (or null)
     * @param effectType        The effect type to use
     * @param customDisplayName Custom display name for teleport messages (or null to use destination name)
     * @return True if successful, false if player is already teleporting
     */
    public boolean startTeleport(Player player, TeleportDestination destination,
                                 int castingTime, TeleportConsumable consumable,
        ...
        // Create teleport session with custom display name
        TeleportSession session = new TeleportSession(
                player, destination, castingTime, consumable, effectType, customDisplayName
        );
