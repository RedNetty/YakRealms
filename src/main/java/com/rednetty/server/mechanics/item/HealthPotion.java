...
public enum HealthPotion {
    MINOR_HEALTH(1, PotionType.REGEN, ChatColor.WHITE + "Minor Health Potion", ChatColor.GREEN, 15),
    HEALTH(2, PotionType.INSTANT_HEAL, ChatColor.GREEN + "Health Potion", ChatColor.AQUA, 75),
    MAJOR_HEALTH(3, PotionType.STRENGTH, ChatColor.AQUA + "Major Health Potion", ChatColor.AQUA, 300),
    SUPERIOR_HEALTH(4, PotionType.INSTANT_DAMAGE, ChatColor.LIGHT_PURPLE + "Superior Health Potion", ChatColor.YELLOW, 800),
    LEGENDARY_HEALTH(5, PotionType.FIRE_RESISTANCE, ChatColor.YELLOW + "Legendary Health Potion", ChatColor.YELLOW, 1600),
    CHILLED_HEALTH(6, PotionType.SPEED, ChatColor.BLUE + "Chilled Health Potion", ChatColor.BLUE, 3200);
